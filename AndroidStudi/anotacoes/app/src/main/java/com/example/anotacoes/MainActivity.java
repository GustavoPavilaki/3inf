...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Anotações 1.0");
        tTexto = findViewById(R.id.tTexto);
        bSalva = findViewById(R.id.bSalvar);
        bSalva.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String textoDigitado = tTexto.getText().toString();
                gravarTexto(textoDigitado);
                Toast.makeText(MainActivity.this, "Anotação salvo com sucesso!", Toast.LENGTH_SHORT).show();
            }
        });
